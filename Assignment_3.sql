...
-- THIS IS THE BEGINING OF ASSIGNMENT:
# Question 2:
SELECT * FROM department;
#Question 3:
SELECT DepartmentID FROM department
WHERE DepartmentName LIKE '%Phong Sale%';
#Question 4:
SELECT *
FROM `account`
...
WHERE CreatedDate < '2019-12-20' AND Duration >= 60;
#Question 9:
SELECT * FROM `group`
ORDER BY CreatedDate DESC LIMIT 5;
#Question 10:
SELECT COUNT(DepartmentID) AS Result FROM `account`
...
#Question 12:
DELETE FROM exam
WHERE CreatedDate < '2019-12-20' AND ExamID <> 0;
#Question 13:
